...
3. A merge to `main` publishes `ghcr.io/stonetusker/tusker-demo-notification-service:<full-sha>`.
4. CI opens a release pull request in this repository.
5. A maintainer reviews and merges the immutable image update.
6. Argo CD detects the overlay change and reconciles `demo-service-development`.
