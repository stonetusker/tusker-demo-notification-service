...
The application repository owns source, tests, CI/CD, TechDocs, OpenAPI and Kubernetes overlays. The TuskerBlueprint platform repository owns the Argo CD Application and shared platform services.
